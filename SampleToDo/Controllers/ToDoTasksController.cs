...
namespace SampleToDo.Controllers
{
    public class ToDoTasksController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TaskID,Name,Description,TaskDone,DueDate")] ToDoTask toDoTask)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TaskID,Name,Description,TaskDone,DueDate")] ToDoTask toDoTask)
        {
            if (ModelState.IsValid)
            {
